...
func TestConnectionPrompter(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			run: func(p *ConnectionPrompterStruct) (interface{}, error) {
				return NewConnectionPrompter(), nil
			},
			wantResult: &ConnectionPrompterStruct{},
			wantErr:    false,
		},

		{
			...
			setup: func(t *testing.T, p *ConnectionPrompterStruct, m *mock_awsctl.MockPrompter) {
				m.EXPECT().PromptForSelection("What would you like to do?", []string{
					SSHIntoBastion, StartSOCKSProxy, PortForwarding, ExitBastion,
				}).Return(SSHIntoBastion, nil)
			},
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.SelectAction() },
			wantResult:     SSHIntoBastion,
			wantErr:        false,
			wantErrMessage: "",
		},
		{
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForSOCKSProxyPort(1080) },
			wantResult:     8080,
			wantErr:        false,
			wantErrMessage: "",
		},
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForBastionHost() },
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForSSHUser("ec2-user") },
			wantResult:     "admin",
			wantErr:        false,
			wantErrMessage: "",
		},
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForLocalPort("testing", 8080) },
			wantResult:     8080,
			wantErr:        false,
			wantErrMessage: "",
		},
...

		{
			...
			setup:          func(t *testing.T, p *ConnectionPrompterStruct, m *mock_awsctl.MockPrompter) {},
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForLocalPort("testing", 0) },
			wantResult:     0,
			wantErr:        true,
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForRemoteHost() },
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForRemotePort("service") },
			wantResult:     80,
			wantErr:        false,
			wantErrMessage: "",
		},
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForSSHKeyPath("~/.ssh/id_rsa") },
...

		{
			...
			run: func(p *ConnectionPrompterStruct) (interface{}, error) {
				...
				return p.PromptForBastionInstance(instances)
			},
			wantResult:     "1.2.3.4",
			wantErr:        false,
			wantErrMessage: "",
		...
		},
		{
			...
			wantResult:     "",
			wantErr:        true,
			wantErrMessage: "failed to select bastion host: selection error",
		},
		{
			name:  "PromptForBastionInstance no instances",
			setup: func(t *testing.T, p *ConnectionPrompterStruct, m *mock_awsctl.MockPrompter) {},
			run: func(p *ConnectionPrompterStruct) (interface{}, error) {
				return p.PromptForBastionInstance([]models.EC2Instance{})
			},
			wantResult:     "",
			wantErr:        true,
		...
		},
		{
			...
			setup: func(t *testing.T, p *ConnectionPrompterStruct, m *mock_awsctl.MockPrompter) {
				m.EXPECT().PromptForSelection("Select connection method:", gomock.Any()).Return("Public IP (direct SSH)", nil)
				m.EXPECT().PromptForSelection("Select bastion instance:", gomock.Any()).Return("bastion1 (i-123) - ", nil)
			},
			run: func(p *ConnectionPrompterStruct) (interface{}, error) {
			...
			wantResult:     "",
			wantErr:        true,
			wantErrMessage: "selected instance has no public IP",
		},
		{
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForConfirmation("Confirm?") },
			wantResult:     true,
			wantErr:        false,
			wantErrMessage: "",
		},
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.PromptForInstanceID() },
			wantResult:     "i-123",
			wantErr:        false,
			wantErrMessage: "",
		},
...

		{
			...
			run:            func(p *ConnectionPrompterStruct) (interface{}, error) { return p.ChooseConnectionMethod() },
			wantResult:     "SSH",
			wantErr:        false,
			wantErrMessage: "",
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			prompter := &ConnectionPrompterStruct{Prompter: mockPrompter}
